...
function assignColors() {
  ...
  for (let i = 0; i < cards.length; i++) {
    ...
    // turnary operator that says if red = red then it will \run through until the 8 colors are paired up.  
    // This is how you assigns the value to this property (or key) for this object  
    ...
    //This is where we add the color value to the div as a class.
    cards[i].classList.add(color)
   
  }
}
    
  // Line 26 assign a value to a color property in assigned object
